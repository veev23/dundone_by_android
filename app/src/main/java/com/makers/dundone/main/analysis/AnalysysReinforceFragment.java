...
import com.makers.dundone.data.etc.ResUpgradeCounts;
...
public class AnalysysReinforceFragment extends Fragment {
    ...
    private void initRequest(){
        ...
        call[0] = Singleton.dundoneService.getUpgradeCountsReinforce(null, null, 13, 20);
        call[1] = Singleton.dundoneService.getUpgradeCountsAmplify(null, null, 12, 20);
        call[2] = Singleton.dundoneService.getUpgradeCountsRefine(null, null, 7, 8);
